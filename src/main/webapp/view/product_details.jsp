            ...
            <nav class="header__navbar">
                <ul class="header__navbar-list">
                    <li class="header__navbar-item ">
                        <a  <c:if test='${sessionScope["account"].isSell == 1}'>
                            href="/ShopBae?action=seller"
                        </c:if>
                                href="/login?action=login"  class="header__navbar-item-seller">Kênh người bán</a>
                    </li>
                    <li class="header__navbar-item ">
                        <a <c:if test='${sessionScope["account"].isAdmin == 1}'>
                            href="../view/admin.jsp"
                        </c:if>
                                href="/login?action=login" class="header__navbar-item-seller">Kênh Admin</a>
                    </li>
